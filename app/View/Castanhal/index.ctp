...
<!-- MENU ESTUDANTES, COMUNS, EMPRESA, GRATUIDADE, COM DIV OCULTA DE DOCUMENTOS NECESSÁRIOS -->
        ...
        <h3 align="center"> Bem vindo à Castanhal! </h3>
        <!-- MENU -->
...
<div id="md-blockEstudantes">
    ...
    <div id="md-contentEstudantes">
       ...
       <a href="/estudantes/cadastrar/Castanhal" id="md-cadastra"> Cadastre-se agora! </a> </p>   
...
<!-- JANELA MODAL DE USUÁRIOS COMUNS -->
   ...
   <div id="md-blockComuns">
    ...
    <a href="/comums/cadastrar/Castanhal" id="md-cadastra"> Cadastre-se agora! </a> </p>   
...
<div id="md-blockEmpresas">
    ...
    <div id="md-contentEmpresas">
       ...
       <a href="/empresas/cadastrar/Castanhal" id="md-cadastra"> Cadastre-se agora! </a> </p>   
...
<div id="md-blockGratuitos">
   ...
   <a href="/gratuitos/cadastrar/Castanhal" id="md-cadastra"> Cadastre-se agora! </a> </p>   
